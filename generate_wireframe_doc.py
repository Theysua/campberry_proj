...
doc = Document()
doc.add_heading('Snowday Wireframes', 0)

def add_header(doc):
    add_box(doc, "[❄ Snowday (beta)]    |    🔍 Find    📋 Lists    📌 My Lists    |    [Sign In]", "E0E0E0")
...
doc.add_heading('Snowday Ratings', level=2)
...
doc.save('Snowday_Wireframe.docx')
print("Wireframe saved as Snowday_Wireframe.docx")
