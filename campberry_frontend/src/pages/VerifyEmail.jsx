            ...
            <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-3xl shadow-xl border border-slate-100 text-center relative overflow-hidden">
                ...
                {status === 'success' && (
                    <div className="animate-fade-in scale-in">
                        ...
                        <Link to="/" className="block w-full text-center bg-[#892233] hover:bg-[#780000] text-white px-6 py-3.5 rounded-xl font-bold shadow-md transition-all hover:shadow-lg hover:-translate-y-0.5">
                            Explore Programs
                        </Link>
                    </div>
                )}
                ...
                {status === 'error' && (
                    <div className="animate-fade-in">
                        ...
                        <Link to="/" className="block w-full text-center border-2 border-[#011936] text-[#011936] hover:bg-slate-50 px-6 py-3.5 rounded-xl font-bold transition-colors">
                            Return to Home
                        </Link>
                    </div>
                )}
